...
INSERT INTO webmap.endpoints ("name", url, location, low_bandwidth, coast_layers, graticule_layer, proxied_url, srs, has_wfs, is_user_service, url_aliases, rest_endpoint) 
VALUES('Polar Code Geoserver', 'http://bslmagl.nerc-bas.ac.uk/geoserver/polarcode/wms', 'cambridge', FALSE, NULL, NULL, NULL, 'admin', 'P0L4rC063', 'EPSG:3031', TRUE, 'https://polarcode.data.bas.ac.uk/geoserver/polarcode/wms', 'http://bslmagl.nerc-bas.ac.uk/geoserver');