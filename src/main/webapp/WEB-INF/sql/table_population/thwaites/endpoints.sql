...
VALUES('Thwaites GIS Geoserver', 'https://thwaitesgis.data.bas.ac.uk/geoserver/gis/wms', 'cambridge', FALSE, NULL, NULL, NULL, 'EPSG:3031', TRUE, FALSE, NULL, 'https://thwaitesgis.data.bas.ac.uk/geoserver');
...
INSERT INTO webmap.endpoints ("name", url, location, low_bandwidth, coast_layers, graticule_layer, proxied_url, srs, has_wfs, is_user_service, url_aliases, rest_endpoint) 
VALUES('Local Geoserver user data', 'https://thwaitesgis.data.bas.ac.uk/geoserver/user/wms', 'cambridge', FALSE, NULL, NULL, NULL, 'EPSG:3031', TRUE, TRUE, NULL, 'https://thwaitesgis.data.bas.ac.uk/geoserver');
