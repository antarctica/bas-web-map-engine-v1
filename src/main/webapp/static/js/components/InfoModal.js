 ...
 */
magic.classes.InfoModal.prototype.show = function(layer) {
    this.layer = layer;
 ...
 */
magic.classes.InfoModal.prototype.legendMarkup = function() {
 ...
 */
magic.classes.InfoModal.prototype.metadataMarkup = function() {
    var md = this.layer.get("metadata");
    if (md) {
        if (md.source.wms_source || (md.source.geojson_source && md.source.feature_name)) {
 ...
 * @param {Object} data
 */
magic.classes.InfoModal.prototype.populateRecordRamadda = function(data) {
    var rec = {};
    var json = data[0];
    if (json) {        
        /* Read abstract */
 ...
 */
magic.classes.InfoModal.prototype.populateRecordWms = function(getCaps, featureName) {
    var rec = {};
 ...
 */
magic.classes.InfoModal.prototype.tabulate = function(rec) {    
