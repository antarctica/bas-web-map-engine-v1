...
magic.classes.ShipPositionButton.prototype.getData = function() {
    ...
    jQuery.ajax({
        ...
        url: "http://add.antarctica.ac.uk/geoserver/assets/wfs?service=wfs&request=getfeature&version=2.0.0&typeNames=assets:latest_ship_positions&outputFormat=json",
        method: "GET",
        success: jQuery.proxy(function(data) {
            ...
            jQuery.each(feats, jQuery.proxy(function(idx, f) {
                ...
                if (f.getGeometry().intersectsExtent(projExtent)) {                            
                    ...
                    fclone.setStyle(magic.modules.VectorStyles["bas_ship"](magic.runtime.viewdata.projection));
