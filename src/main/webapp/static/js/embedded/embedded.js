...
function getAttribution(nd) {
    if (nd.attribution) {
        ...
        var legendUrl = getOgcEndpoint(nd.wms_source, "wms") + 
            ...
            "&legend_options=" + encodeURIComponent("fontName:Bitstream+Vera Sans Mono;fontAntiAliasing:true;fontColor:0xffffff;fontSize:6;bgColor:0x272b30;dpi:180") + cacheBuster;
        return(
