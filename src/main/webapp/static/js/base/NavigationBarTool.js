 ...
 * @param {string} id
 */
magic.classes.NavigationBarTool.prototype.addTagsInput = function (id) {
 ...
 */
magic.classes.NavigationBarTool.prototype.populateTagsInput = function (id, value) {
    var elt = jQuery("#" + this.id + "-" + id);
    if (elt.length > 0) {
 ...
 * @param {string} id
 */
magic.classes.NavigationBarTool.prototype.resetTagsInput = function (id) {
    var elt = jQuery("#" + this.id + "-" + id);
    if (elt.length > 0) {
