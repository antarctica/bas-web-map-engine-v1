    ...
    return({
        ...
        loadMap: function(context) {
            ...
            if (resetMap || !this.map) {
                ...
                var wms = magic.modules.creator.Data.WMS_ENDPOINTS[context.data.projection][0]["wms"];
                var coasts = magic.modules.creator.Data.WMS_ENDPOINTS[context.data.projection][0]["coast"];
                var layers = [];
